...
6. For a big or wide change, spawn several subagents on the same question, each from a different angle, and merge the answers. If another model family is available, use it for one of them. Different models catch different real bugs.
