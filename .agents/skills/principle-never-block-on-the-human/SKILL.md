...
**Boundaries:**
- **Irreversible or outward-facing actions** (commit, push, open or comment on a PR, delete data, send messages) still require confirmation unless the human granted autonomy for them.
- **Local, reversible actions** (write code, edit notes, split tasks) should proceed without blocking.
