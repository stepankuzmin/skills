...
- `Skill` tool calls, and `Read` calls against any `SKILL.md` file (project `.claude/skills/` or `.agents/skills/`, user-level `~/.claude/skills/`, or plugin paths under `~/.claude/plugins/`)
- Subagent prompts that name a skill
