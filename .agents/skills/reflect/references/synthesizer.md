...
| <new pattern, no existing skill is a real home> | <draft a new skill via skill-creator> | <new skill: <kebab-name>> |
...
For each item, describe the pattern, what was hit, and the suggested mechanism. The parent lists them for the user.
