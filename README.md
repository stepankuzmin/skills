...
| [`manage-skills`](plugins/stepankuzmin-skills/skills/manage-skills/SKILL.md) | Add, update, remove, or install skills in the stepankuzmin-skills plugin from any repo, through the repo's GitHub workflows. |
